...
import (
	...
	"github.com/project-alvarium/scoring-apps-go/internal/populator"
)
...
func main() {
	...
	cfg := populator.ApplicationConfig{}
	...
	worker := populator.NewWorker(dbArango, dbMongo, logger)
